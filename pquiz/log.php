<?
  ...
  start_time();
  $r = mysql_query("SELECT l_log.i_id, i_anames, l_line, l_log.w_id, l_mr, l_authors.a_id, a_id2, l_time, l_correct, l_total, l_time, l_ip, l_session, w_name, a_name, w_rating, w_years
    FROM l_log 
    LEFT JOIN l_works USING (w_id) 
    LEFT JOIN l_authors ON (l_authors.a_id=l_works.a_id)
    LEFT JOIN l_isles ON (l_log.i_id=l_isles.i_id)
