...
<meta property='og:title' content='Угадай писателя!' />
<?  
if ($q_num == 0) $q_num = $mr_levels[$mr];
if ($correct>0) { ?>
<meta property='og:description' content='Попробуйте отгадать <?=$correct; ?> писателей подряд из <?=$q_num; ?> книг как я!' />
<? } ?>
...
<a href=levels.php><img width=170 align=absmiddle style="vertical-align:middle" border=0 src=i/rlit.png></a>
<td>
<table width=100%>
<tr>
<td>
...
data-url='<? echo "$url_share/rlit/"; ?>'
data-image='<? echo "$url_share/rlit/i/rlit_560.png"; ?>'
data-counter=''></div>
</table>
&nbsp;
<a href=levels.php>Угадай писателя</a> |
<a href=authors.php>Писатели</a> |
<?
  echo "<a href=$url_main/rlmap>Карта писателей</a> | ";
?>
