<meta charset=utf-8 />
<meta property='og:image' content='<? echo "$url_share/rfil/i/rfil_560.png"; ?>' />
<meta property='og:title' content='Угадай философа' />
<? if ($correct>0) { ?>
<meta property='og:description' content='Угадай философа' />
<? } ?>
...
<a href=levels.php><img width=170 align=absmiddle style="vertical-align:middle" border=0 src=i/rfil.png></a>
<td>
<table width=100%>
<tr>
<td>
...
data-url='<? echo "$url_share/rfil/"; ?>'
data-image='<? echo "$url_share/rfil/i/rfil_560.png"; ?>'
data-counter=''></div>
</table>
&nbsp;
<a href=levels.php>Угадай философа</a> |
<a href=authors.php>Философы</a> |
<?
  echo "<a href=$url_main/rfmap>Карта философов</a> | ";
?>
<a href=pi-fil.php>Острова</a> |
