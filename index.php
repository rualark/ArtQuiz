<?
  ...
  echo '<link rel="stylesheet" href="css/tabs.css" type="text/css" media="screen, projection" />';
  include "url.php";
  include "style.php";
...
<section class="tabs">
	...
	<label for="tab_1" id="tab_l1">Music</label>
	<label for="tab_2" id="tab_l2">Paintings</label>
	<label for="tab_3" id="tab_l3">English texts</label>
	<label for="tab_4" id="tab_l4">Русские тексты</label>
	<div style="clear:both"></div>


<?
  function show_theader($cid, $type=0) {
    GLOBAL $size2;
    echo "<div id='tab_$cid'>";
    if ($type == 0) echo "<br>";
    ...
    if ($type == 0) {
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Quizes:";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Timelines:";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Databases:";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Other:";
    }
    if ($type == 1) {
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Quizes:";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Timelines:";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Databases:";
    }
    if ($type == 2) {
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Викторины:";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Карты:";
      echo "<td><font color=#000000 size=$size2 face='$font1'><center>Базы:";
    }
  }

  echo '<div class="tabs_cont">';
  ...
  $ci = 5;
  echo "<tr>";
  title('Philosophers', $ci, $size1);
  echo "<td bgcolor=$colb[$ci]><center>";
  //btn('Угадай философа', 'rfil', $ci, $size3);
  btn('Guess philosopher', 'equotes', $ci, $size3);
  echo "<td valign=middle bgcolor=$colb[$ci]><center>";
  btn('Philosophers timeline', 'efmap', $ci, $size3);
  echo "<td bgcolor=$colb[$ci]><center>";
  //btn('Философы', 'rfil/authors.php', $ci, $size3);
  btn('Philosophers', 'equotes/authors.php?type=Philosopher', $ci, $size3);
  ...
  $ci = 5;
  echo "<tr>";
  title('Философы', $ci, $size1);
  echo "<td bgcolor=$colb[$ci]><center>";
  btn('Угадай философа', 'rfil', $ci, $size3);
  echo "<td valign=middle bgcolor=$colb[$ci]><center>";
  btn('Карта философов', 'rfmap', $ci, $size3);
  echo "<td bgcolor=$colb[$ci]><center>";
  btn('Философы', 'rfil/authors.php', $ci, $size3);
  ...
  echo "<p><font face='$font1'>Timelines are clickable: you will be able to see examples for each artist, composer or writer immediately.";
