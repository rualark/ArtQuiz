<?
  ...
  echo '<script src="sweetalert/dist/sweetalert.min.js"></script>';
  echo '<link rel="stylesheet" type="text/css" href="sweetalert/dist/sweetalert.css">';
  include "menu.php";
  ...
  echo "<table cellpadding=5 border=0 width=600>";
  ...
  echo "> <a onclick='swal(\"If you choose to play only 1-minute interval of each track, you will get more rating for each correct answer, because it increases difficulty\")' href='javascript:void(0)'><img style='opacity: 0.5' valign=top src=images/help.png height=18></a>";
  ...
  echo "> <a onclick='swal(\"If you choose to select answer from all composers, you will get more rating for each correct answer, because it increases difficulty\")' href='javascript:void(0)'><img style='opacity: 0.5' valign=top src=images/help.png height=18></a>";

  echo "<tr>";
  echo "<td>";
  echo "Train after wrong answer: ";
  echo "<td>";
  echo "<input onChange='this.form.submit();' type=checkbox name=train value=1";
  if ($us[u_train]) echo " checked";
  echo "> <a onclick='swal(\"Train mode allows more attempts to guess same composer after wrong answer. These additional attempts do not affect rating.\")' href='javascript:void(0)'><img style='opacity: 0.5' valign=top src=images/help.png height=18></a>";
  ...
  if ($us[u_level] >= $level_cust) {
    ...
    $r = mysql_query2("SELECT cc_composers.c_id as c_id, map_pos, c_rating, c_total, c_name3, c_name4, c_group, p_name, p_id, t_count, tg_list, tr_count,
    ...
    $cur_rat=1;
    for ($x=1; $x<5; $x++) {
      echo "<td valign=top><a title='Check/clear all composers in this level' href=prefs.php?setl=$x><font color=black size=+2>".$level_name[$x]."</font></a><br>";
      $p_name = "";
      for ($i=0; $i<$n; $i++) {
        ...
        //if (!is_file("$url_cpic/$w[c_id].jpg")) echo "<font color=red>";
  ...
  echo "<p>";
  echo '<div class="container" style="width: 620px">';
  echo '<div class="header"  align=left><span>Advanced settings...</span></div>';
  echo '<div class="content">';
  
  echo "<table cellpadding=5 border=0 width=600>";
  echo "<tr>";
  echo "<td colspan=2>";
  echo "<b>Setup style:</b> ";
  echo "<tr>";
  echo "<td width=200>";
  echo "Visual style: ";
  echo "<td>";
...
$(".header").click(function () {
    ...
    $content.slideToggle(500, function () {
        ...
        $header.text(function () {
            ...
            return $content.is(":visible") ? "Advanced settings" : "Advanced settings...";
        });
    });
...
<?
  ...
  echo "</div>";
  echo "</div>";
  echo "<p><a href=quiz.php><img height=70 src=i/button-play.png></a>";
?>
