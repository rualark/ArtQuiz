<?
  ...
  for ($i=0; $i<$n; $i++) {
    ...
    */
    ...
    echo " <a target=_blank href='http://www.google.ru/search?q=pdf ".$sst."'><img src=images/search.png height=16></a>";
    // Paintings
    /*
    $q2 = "SELECT t_id FROM ca_log LEFT JOIN aq_artists USING (a_id) WHERE t_id='$w[t_id]' AND v_up>(v_down*2.5)";
    $r2 = mysql_query($q2);
    echo mysql_error();
    $n2 = mysql_numrows($r2);
    echo " <font color=red size=+2><b>$n2</b></font> ";
    */
    echo "<br>\n";
    $wa[$i] = $w;
  }
