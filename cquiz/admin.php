<?
  ...
  echo "<p align=right>";
  echo "<a href=admin_resetpass.php>Reset pass</a> | ";
  ...
  echo "<th>Games";
  echo "<th>Active days";
  $r = mysql_query2("SELECT u_id, u_name, u_total3, u_since, u_email, u_last, 
    DATEDIFF(u_last, u_since) as days, u_source FROM cc_users 
  ...
  for ($i=0; $i<$n; $i++) {
    ...
    echo "<td title='$w[u_last]'><center>";
    if ($w[days]>0) echo "$w[days]";
  }
  echo "</table>";
