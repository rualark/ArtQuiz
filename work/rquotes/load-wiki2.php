<?
  ...
  if ($a_id != 0) {
    mysql_query("UPDATE rq_authors SET a_ename='', a_ewiki='', a_wiki='', a_desc2='', gs_id='', w_name='' WHERE a_id='$a_id'");
    echo mysql_error();
    echo "Cleared $a_id";
    exit;
  }
  ...
  for ($i=0; $i<$n; $i++) {
    ...
    //if ($good) echo "<b>";
    if (!$good) {
      if (levenshtein($w[a_name], $w[w_name]) < 4) {
        ...
        //mysql_query("UPDATE rq_authors SET a_ename='', a_ewiki='', a_wiki='', a_desc2='', gs_id='', w_name='' WHERE a_id='$w[a_id]'");
        echo mysql_error();
      }
    }
  }
