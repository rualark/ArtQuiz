<?
  ...
  // Count density
  $q = "SELECT a_year1, a_year2 FROM rl_authors WHERE a_rating<100";
  $r = mysql_query($q);
  echo mysql_error();
  $n = mysql_numrows($r);
  for ($i=0; $i<$n; $i++) {
  ...
  $acnt[-600/$cent_step] = 0.7;
  $acnt[-500/$cent_step] = 0.7;
  $acnt[-400/$cent_step] = 0.7;
  $acnt[-300/$cent_step] = 0.7;
  $acnt[-200/$cent_step] = 0.7;
  $acnt[-100/$cent_step] = 0.7;
  $acnt[0/$cent_step] = 0;
  $acnt[100/$cent_step] = 0.2;
  $acnt[200/$cent_step] = 0.2;
  $acnt[300/$cent_step] = 0.2;
  $acnt[400/$cent_step] = 0.2;
  $acnt[500/$cent_step] = 0.2;
  $acnt[600/$cent_step] = 0.2;
  $acnt[700/$cent_step] = 0.2;
  $acnt[800/$cent_step] = 0.2;
  $acnt[900/$cent_step] = 0.2;
  $acnt[1000/$cent_step] = 0.2;
  $acnt[1100/$cent_step] = 0.2;
  $acnt[1200/$cent_step] = 1;
  $acnt[1300/$cent_step] = 1;
  $acnt[1400/$cent_step] = 2;
  $acnt[1500/$cent_step] = 3;
  $acnt[1600/$cent_step] = 5;
  $acnt[1700/$cent_step] = 20;
