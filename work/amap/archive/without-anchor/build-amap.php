<?
  ...
  function make_area($x1, $y1, $x2, $y2, $href, $title) {
    return "<a href='$href'><div class=area style='position:absolute; width:".
      ($x2-$x1)."px; height:".($y2-$y1)."px; left:{$x1}px; top:{$y1}px'></div></a>";
  }
