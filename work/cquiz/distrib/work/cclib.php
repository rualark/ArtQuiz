<?
  $offline_site = 0;
  if ($offline_site) {
    $link_amp = "http://alch.16mb.com";
    $link_search1 = "http://alch.16mb.com/classclass/search.php";
    $link_search2 = "http://alch.16mb.com/classclass/search.php";
    $link_am = "http://alch.16mb.com/classclass/am.php";
  } else {
    $link_amp = "../index.php";
  ...
  function write_menu($fh, $title, $hr=0) {
    ...
    fputs($fh, "<tr>\n");
    fputs($fh, "<td>\n");
    fputs($fh, "<a border=0 href=frame1.htm><img border=0 align=middle src=i/Classclass200.png></a><br> <b>Classical music classification</b>\n");
    fputs($fh, "</td>\n");
    fputs($fh, "<td>\n");
    fputs($fh, "<font face=arial size=4>\n");
    fputs($fh, "<a href=frame1.htm>Timeline</a> |\n");
    fputs($fh, "<a href=graph2.htm>Graph</a> |\n");
    fputs($fh, "<a href=gtree.htm>Tree</a> |\n");
    fputs($fh, "<a target=_blank href='http://en.wikipedia.org/wiki/List_of_classical_music_composers_by_era'>Composers</a> |\n");
    fputs($fh, "<a href=contact.htm>Contact</a>\n");
    fputs($fh, "</td>\n");
    fputs($fh, "<td>\n");
